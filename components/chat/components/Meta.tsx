...
import RouterEvenets from '../../../lib/router-events';

// It's okay to use a magic number for this occasion
// tslint:disable-next-line:no-magic-numbers
const start = debounce(NProgress.start, 200);

RouterEvenets.on('routeChangeStart', start);

RouterEvenets.on('routeChangeComplete', () => {
  start.cancel();
  NProgress.done();
});

RouterEvenets.on('routeChangeError', () => {
  start.cancel();
  NProgress.done();
});
